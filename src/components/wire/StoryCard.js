                  ...
                  <div className="clay-glass breaking-execution-banner" style={{ margin: '20px 0', borderLeft: '3px solid var(--color-shift-red)' }}>
                    ...
                    <div className="execution-details-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', fontSize: '0.82rem' }}>
                      <div>
                        ...
                        <span className="edge-market-name" style={{ color: 'var(--color-linen)', fontWeight: 600 }}>{chart_data.execution.pair}</span>
                      </div>
                      <div>
                        <span className="execution-detail-label" style={{ color: 'var(--color-sage)' }}>Side:</span>{' '}
                        <span className="edge-market-name" style={{ color: 'var(--color-linen)', fontWeight: 600 }}>{chart_data.execution.side}</span>
                      </div>
                      <div>
                        <span className="execution-detail-label" style={{ color: 'var(--color-sage)' }}>Qty:</span>{' '}
                        <span className="edge-market-name" style={{ color: 'var(--color-linen)', fontWeight: 600 }}>{chart_data.execution.qty}</span>
                      </div>
                      <div>
                        <span className="execution-detail-label" style={{ color: 'var(--color-sage)' }}>Price:</span>{' '}
                        <span className="edge-market-name" style={{ color: 'var(--color-linen)', fontWeight: 600 }}>${parseFloat(chart_data.execution.price || 0).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                )}
